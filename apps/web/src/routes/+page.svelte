...
<main class="min-h-screen bg-slate-900 flex flex-col items-center p-8 font-sans text-slate-100">
  ...
  <div class="w-full max-w-6xl">
    ...
    {:else}
      ...
      {:else}
        <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-16 items-start animate-fade-in">
